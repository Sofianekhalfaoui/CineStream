...
export const translations: Translations = {
  ...
  top10Today: { ar: 'أفضل الأفلام', en: 'Top Movies', fr: 'Top Films' },
  ...
  dramaMovies: { ar: 'أفلام الدراما', en: 'Drama Movies', fr: 'Drame' },
  bollywoodMovies: { ar: 'أفلام هوليود (هندي)', en: 'Hollywood (Indian)', fr: 'Hollywood (Indien)' },
  documentaries: { ar: 'الأفلام الوثائقية', en: 'Documentaries', fr: 'Documentaires' },
  originalTitle: { ar: 'إنتاجات فلك بلاي', en: 'FalakPlay Originals', fr: 'Originaux FalakPlay' },
